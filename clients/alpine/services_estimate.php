...
?>
			<div id="page_content_right">
				<h2><img src="./images/titles/short_request_an_estimate.png" /></h2>
				...
				<table class="plain padding">
					...
					<tr>
						<td class="align_right valign_top"><label class="highlight_darkgreen" for="message">Description of Project</label></td>
